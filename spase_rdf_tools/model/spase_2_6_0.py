...
class InstrumentType(Enum):
    ...
    :cvar SOLID_STATE_DETECTOR: A detector of the charge carriers
        (electrons and holes) model in semiconductors by energy
...
class ModelType(Enum):
    ...
    :cvar PIC: A numerical scheme modeling ions and electrons as
        macroparticles.
    :cvar PARABOLOID: A shape model by the rotation of a parabola
...
class ModeledRegion(Enum):
    ...
    :cvar EARTH_MAGNETOSPHERE_RING_CURRENT: One of the major current
        ...
        magnetospheres. It is model by the longitudinal drift of
...
class Role(Enum):
    ...
    :cvar DATA_PRODUCER: An individual who model the resource and is
